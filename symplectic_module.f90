...
!
! A modification of my time-evolution module to make it more object-oriented and less hackish looking
!
! Main feature to implement, rather than having to pass fld, fldp, tglob into all of the subroutines, I want to instead implement and initialize fields, time, etc. into the Hamiltonian module
!
! I can then call step(dt, nsteps) instead of the ugly crap I have now
! The step will then effectively call my Hamiltonian object (storing the fields, etc.) and tell it to update itself
!
! Note: This will be a bit harder than I'd like since I'm using OpenMP and it won't play nice (due to scoping) with this approach.
! I will really have to make it object oriented and have each thread create a new copy of the Hamiltonian object (this is of course more elegant than what I'm doing now)
