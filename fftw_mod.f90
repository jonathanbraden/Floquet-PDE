...
!
! Plan allocation for laplacians.  Measure once to improve speed
!
    subroutine make_plan_3d(f, Fk, planf, planb)
      real(C_DOUBLE) :: f
      real(C_DOUBLE_COMPLEX) :: Fk
      type(C_PTR) :: planf, planb

    end subroutine make_plan_3d
